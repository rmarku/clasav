 ...
 */
    function drawCanvasMinimap() {
        ...
        if (canvasMinimap.getContext) {
            ...
            ctxMinimap.arc(~~(game.mainPlayer.pos.x*156/1344), ~~(game.mainPlayer.pos.y*156/1344),2, 0, 2 * Math.PI, true); ctxMinimap.fill();
...
/*
 function drawPlayers(value,index,ar){
 var canvasMinimap = document.getElementById("canvasMinimap");
 if (canvasMinimap.getContext) {
 var ctxMinimap = canvasMinimap.getContext("2d");
 ctxMinimap.beginPath();
 ctxMinimap.fillStyle = '#FFFFFF';
 ctxMinimap.arc(~~(value.pos.x*156/1344), ~~(value.pos.y*156/1344),2, 0, 2 * Math.PI, true); ctxMinimap.fill();
 ctxMinimap.lineWidth = 1;
 ctxMinimap.strokeStyle = '#00FFEF';
 ctxMinimap.stroke();
 }
 }
 */
